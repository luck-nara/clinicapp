...
class SearchsickScreen extends StatefulWidget {
  @override
  _SearchsickScreenState createState() => _SearchsickScreenState();
}

class _SearchsickScreenState extends State<SearchsickScreen> {
  var _data;
                    ...
                    ? FutureBuilder(builder: (context, snapshot) {
                        return ListView.separated(
                          ...
                          itemBuilder: (context, i) {
                            if (_data[i]["search_clinics"].contains(name)) {
                              return ListTile(
                                title: Container(
                                    width: 350,
                                    decoration: BoxDecoration(
